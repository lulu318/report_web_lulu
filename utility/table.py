    ...
    project_costs_df = pd.DataFrame(
        {
            ...
            "比例 ( % )": [html.H5("100"), _bank_loan_fee_percent, _actual_expenses_percent, "",
...
def warranty_cost_df(illustrate_7years, illustrate_20years, scale_7years, scale_20years,
    ...
    _illustrate_5years = html.H5(
        callback_fuc.illustrate_5years())  # '="售電收入"&C24*100&"%"'
    _illustrate_6years = html.H5(
        callback_fuc.illustrate_6years())  # '="售電收入"&C25*100&"%"'
    ...
    _scale_5years = html.H5(callback_fuc.scale_5years())  # "0%"
    _scale_6years = html.H5(callback_fuc.scale_6years())  # "6%"
    ...
    _amount_5years = html.H5(callback_fuc.amount_5years())  # "0%"
...
def operating_expense_df(illustrate_cleaning_fee_water, illustrate_property_insurance_costs,
    ...
    # _illustrate
    _illustrate_cleaning_fee_water = html.H5(
        callback_fuc.illustrate_cleaning_fee_water())  # B33="每年"&C33*100&"%"
    _illustrate_property_insurance_costs = html.H5(
        callback_fuc.illustrate_property_insurance_costs())  # B34="每年"&C34*100&"%""
    # _scale
    _scale_cleaning_fee_water = html.H5(
        callback_fuc.scale_cleaning_fee_water())  # "C33 0.025%"
    _scale_property_insurance_costs = html.H5(
        callback_fuc.scale_property_insurance_costs())  # "C34 0.5%"
...
def wholesale_rate_df():
    _customer_offers_costs = "aaa"  # D20 "=ROUND(D9/5,0)"
...
def return_on_investment_df(ese_1, ese_2, ese_3, ese_4, ese_5, ese_6, ese_7, ese_8, ese_9, ese_10,
                            ...
                            lds_11, lds_12, lds_13, lds_14, lds_15, lds_16, lds_17, lds_18, lds_19, lds_20, lds_sum, lds_average):
    ...
    return_on_investment_df = pd.DataFrame(
        {
            ...
            "貸款支出表": ["-", _lds_1, _lds_2, _lds_3, _lds_4, _lds_5, _lds_6, _lds_7, _lds_8, _lds_9, _lds_10, \
                      _lds_11, _lds_12, _lds_13, _lds_14, _lds_15, _lds_16, _lds_17, _lds_18, _lds_19, _lds_20, \
                      _lds_sum, _lds_average],

            # customer_discount_program cdp
            "客戶優惠專案": ["-", "=G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22", "G23",
                       "G24", "G25", "G26", "G27", "G28", "29", "30", "31", "32", "sum", "average"],

            # warranty_fee warranty
            "保固費用": ["-", "=G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22", "G23",
                     "G24", "G25", "G26", "G27", "G28", "29", "30", "31", "32", "sum", "average"],

            # operating_expenses oe
            "營運費用": ["-", "=G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22", "G23",
                     "G24", "G25", "G26", "G27", "G28", "29", "30", "31", "32", "sum", "average"],

            # total_return_on_investment total_r
            "合計表": ["-", "=G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22", "G23",
                    "G24", "G25", "G26", "G27", "G28", "29", "30", "31", "32", "sum", "average"],

            # cash_flow
            "現金流": ["-", "=G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22", "G23",
                    "G24", "G25", "G26", "G27", "G28", "29", "30", "31", "32", "sum", "average"],
        }
    )
